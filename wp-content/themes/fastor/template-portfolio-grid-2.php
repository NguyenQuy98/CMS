<?php get_header();
/**
 * Template Name: Portfolio Grid 3 Column Template
 */
...
if( $fastor_query->have_posts() ) : ?>
    <!-- Main content start -->
    <div id="template-portfolio" <?php post_class(); ?> data-portfolio-template="portfolio-grid-2">
        <?php get_template_part( 'template-parts/portfolio-filter' ); ?>
        <div class="portfolio-list-wrapper masonry-wrapper template-portfolio-grid-2">
