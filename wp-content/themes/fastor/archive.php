...
<!--        --><?php
//        if ( is_category() ) :
//            printf( esc_html__( 'Category Archives: %s', 'fastor' ), '<span>' . single_cat_title( '', false ) . '</span>' );
//
//        elseif ( is_tag() ) :
//            printf( esc_html__( 'Tag Archives: %s', 'fastor' ), '<span>' . single_tag_title( '', false ) . '</span>' );
//
//        elseif ( is_author() ) :
//
//            the_post();
//            printf( esc_html__( 'Author Archives: %s', 'fastor' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
//            rewind_posts();
//
//        elseif ( is_day() ) :
//            printf( esc_html__( 'Daily Archives: %s', 'fastor' ), '<span>' . get_the_date() . '</span>' );
//
//        elseif ( is_month() ) :
//            printf( esc_html__( 'Monthly Archives: %s', 'fastor' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );
//
//        elseif ( is_year() ) :
//            printf( esc_html__( 'Yearly Archives: %s', 'fastor' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
//
//        else :
//            esc_html_e( 'Archives', 'fastor' );
//
//        endif;
//        ?>
<!--    </h1>-->
