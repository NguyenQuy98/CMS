                ...
                <div class="pattern">
                    <div class="top-bar">
                        <div class="container">
                            ...
                            <?php if ( is_user_logged_in() ) : ?>
                                ...
                                <?php if(defined('WC_VERSION')): ?>
                                    <div class="dropdown account">
                                        <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" onclick="window.location.href = '<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>'"
                                          data-hover="dropdown" data-toggle="dropdown">
                                            <i class="fa fa-user"></i>
                                            <?php esc_html_e('My Account','fastor'); ?>
                                        </a>
                            ...
                            <!-- Links -->
                            <?php echo fastor_html_topmenu(false) ?>
