...
$post = fastor_get_woocommerce_loop();
...
if ( $upsells ) : ?>
    ...
    ?>
    <?php if($fastor_options['productpage-upsells-status']) { ?>
    <div class="box clearfix">
        ...
        <div class="box-heading"><?php  esc_html_e( 'You may also like&hellip;', 'fastor' ); ?></div>
