<?php
/**
 * Template Name: Portfolio Masonry 3 Column Template
 */
get_header();
...
if( $fastor_query->have_posts() ) : ?>
    <!-- Main content start -->
    <div id="template-portfolio" <?php post_class(); ?> data-portfolio-template="portfolio-masonry-2">
        <?php get_template_part( 'template-parts/portfolio-filter' ); ?>
        <div class="portfolio-list-wrapper masonry-wrapper template-portfolio-masonry-2">
