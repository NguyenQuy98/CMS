...
// Register Easy Bootstrap Shortcodes in Visual Composer Editor / Fastor Category
if (function_exists('vc_set_as_theme')) {

    function fastor_vc_shortcode_bootstrap() {
        ...
        $vc_icon = fastor_vc_icon().'bs_columns.png';
